    ...
    <div class="page-body">
        <div class="card">
            ...
            <div class="card-block">
                <form method="POST" action="{{ route('proker.update', $proker->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-sm-10">
                            <select name="dept_id" class="form-control">
                                ...
                                @forelse ($depts as $item)
                                    @if ($item->id === $proker->dept_id)
                                        <option value="{{ $item->id }}" selected>Kabinet {{ $item->name_dpt }}
                                        </option>
                                    @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ $proker->proker }}" name="proker" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="desc_proker" rows="5" cols="5" class="form-control"
                                placeholder="Contoh: OPTIMASI merupakan kegiatan...">{{ $proker->desc_proker }}</textarea>
                        </div>
                    </div>
