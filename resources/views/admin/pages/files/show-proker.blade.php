        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <i class="ti-folder bg-c-blue"></i>
                    <div class="d-inline">
                        <h4>Berkas & Persuratan</h4>
                        <span>Berkas dan persuratan dari setiap program kerja departemen periode 2024/2025.</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#">Berkas & Persuratan</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="card-block">
                ...
                <ul class="nav nav-tabs tabs" role="tablist">
                    @forelse ($depts as $item)
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('!4dm1n/file#' . $item->name_dpt) ? 'active' : '' }}"
                ...
                <div class="tab-content tabs card-block">
                    @forelse ($depts as $dept)
                        <div class="tab-pane {{ request()->is('!4dm1n/file#' . $dept->name_dpt) ? 'active' : '' }}"
                            ...
                            @foreach ($pro as $key => $item)
                                @if ($item->dept_id === $dept->id)
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="d-flex">
                                                <a href="{{ route('files.index', $item->id) }}"
                                                    class="btn btn-info btn-round">BERKAS</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
