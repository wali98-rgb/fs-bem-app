            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="{{ route('verification.code.post', ['token' => $token]) }}"
                            ...
                            <div class="auth-box">
                                <div class="row m-b-10">
                                    <div class="col-md-12">
                                        <h3 class="text-center mt-1 txt-primary">Konfirmasi Kode Divisi</h3>
                                    </div>
                                </div>
                                <hr style="color: black" />
                                <div class="input-group">
                                    <p style="color: black; font-size: .9rem; text-align: left;" class="m-0">
                                        Silahkan masukkan kode divisi Anda.
                                    </p>
                                </div>

                                <div class="input-group">
                                    <input id="code_division" type="text" class="form-control" name="code_division"
                                        value="{{ old('code_division') }}" required autocomplete="code_division" autofocus
                                ...
                                <div class="row m-t-30 m-b-10">
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary btn-md btn-block waves-effect text-center">Konfirmasi</button>
                                    </div>
                                </div>
