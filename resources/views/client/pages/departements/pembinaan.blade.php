            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Departemen Pemikat Regis</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
              <div class="position-relative h-100">
                  <img class="img-fluid position-absolute w-100 h-100" 
                       src="{{ asset('plugins/frontend/img/pembinaan.png') }}" 
                       alt="" 
                       style="object-fit: contain; ">
              </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              <h6 class="section-title bg-white text-start text-primary pe-3">Departemen Pemikat Regis</h6>
              <h1 class="mb-4">Tugas Pokok dan Fungsi</h1>
              <p class="mb-4 " style="text-align: justify;">Bertanggung jawab untuk merancang dan melaksanakan kegiatan pembinaan bakat mahasiswa di berbagai bidang, serta menjadi penghubung antara pihak internal kampus dan eksternal. Tugas ini mencakup menyediakan fasilitas untuk pengembangan keterampilan mahasiswa dan menjalin kolaborasi atau hubungan diplomatik dengan pihak luar untuk membuka peluang dan memperluas jaringan.
              <div class="row gy-2 gx-4 mb-4" >
                
                      <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Program Kerja</p>
                      <ul>
                          <li>Mengadakan kegiatan rutin Impact </li>
                          <li>Mengadakan kegiatan Porak internal</li>
                          <li>Mengurus UKM (dapat dibantu sosial Masyarakat)</li>
                          <li>Melakukan Hubungan diplomatik atau studi Banding</li>
                        </ul>
