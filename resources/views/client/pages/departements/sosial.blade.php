            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Departemen Sosial</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
              <div class="position-relative h-100">
                  <img class="img-fluid position-absolute w-100 h-100" 
                       src="{{ asset('plugins/frontend/img/sosial.png') }}" 
                       alt="" 
                       style="object-fit: contain; ">
              </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              <h6 class="section-title bg-white text-start text-primary pe-3">Departemen Sosial</h6>
              <h1 class="mb-4">Tugas Pokok dan Fungsi</h1>
              <p class="mb-4 " style="text-align: justify;">Bertanggung jawab untuk merancang, melaksanakan, dan mengelola kegiatan sosial yang memberikan manfaat bagi masyarakat kampus dan mahasiswa, dengan tujuan menciptakan dampak positif yang berkelanjutan. Peran ini melibatkan upaya untuk meningkatkan kualitas kehidupan kampus melalui kegiatan yang menyentuh berbagai aspek, seperti bantuan sosial, pengembangan masyarakat, serta peningkatan kesadaran akan isu-isu penting. Selain itu, tanggung jawab ini juga mencakup pemantauan dan evaluasi terhadap keberhasilan program-program sosial yang dilaksanakan untuk memastikan dampaknya tetap relevan dan bermanfaat bagi seluruh elemen kampus
              <div class="row gy-2 gx-4 mb-4" >
                
                      <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Program Kerja</p>
                      <ul>
                          <li>Aspirasi Mahasiswa Setiap 1 bulan Sekali</li>
                          <li>Kegiatan Online "Ask Me Anything" (AMA)</li>
                          <li>Membuat Menfess</li>
                        </ul>
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
  <div class="container">
      <div class="text-center">
          <h6 class="section-title bg-white text-center text-primary px-3">Departemen Sosial</h6>
