            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Departemen Komdigi</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
              <div class="position-relative h-100">
                  <img class="img-fluid position-absolute w-100 h-100" 
                       src="{{ asset('plugins/frontend/img/komdigi.png') }}" 
                       alt="" 
                       style="object-fit: contain; ">
              </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              <h6 class="section-title bg-white text-start text-primary pe-3">Departemen Komdigi</h6>
              <h1 class="mb-4">Tugas Pokok dan Fungsi</h1>
              <p class="mb-4 " style="text-align: justify;">Bertanggung jawab untuk merancang, mengembangkan, dan mengelola platform digital, serta menyebarluaskan informasi terkait kegiatan kabinet melalui saluran komunikasi yang efektif. Tugas ini mencakup pembuatan desain visual, pengelolaan website, serta strategi komunikasi yang memaksimalkan penyebaran informasi, baik secara online maupun offline. Selain itu, peran ini juga melibatkan pemeliharaan dan pembaruan konten, serta penggunaan teknologi untuk meningkatkan jangkauan dan interaksi dengan audiens.
              <div class="row gy-2 gx-4 mb-4" >
                
                      <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Program Kerja</p>
                      <ul>
                          <li>Mengembangkan atau Membuat Web BEM</li>
                          <li>Membuat Design untuk konten Media Sosial BEM</li>
                        </ul>
