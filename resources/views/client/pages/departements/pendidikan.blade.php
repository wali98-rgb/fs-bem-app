            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Departemen Pendidikan</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
              <div class="position-relative h-100">
                  <img class="img-fluid position-absolute w-100 h-100" 
                       src="{{ asset('plugins/frontend/img/pendidikan.png') }}" 
                       alt="" 
                       style="object-fit: contain; ">
              </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              <h6 class="section-title bg-white text-start text-primary pe-3">Departemen Pendidikan</h6>
              <h1 class="mb-4">Tugas Pokok dan Fungsi</h1>
              <p class="mb-4 " style="text-align: justify;">Bertanggung jawab untuk menyelenggarakan dan mengelola program kegiatan yang berfokus pada pengembangan akademik, termasuk merancang, mengimplementasikan, serta memantau berbagai inisiatif yang dapat meningkatkan kualitas dan efisiensi pendidikan. Selain itu, tanggung jawab ini juga mencakup evaluasi terhadap dampak program, perbaikan berkelanjutan, dan pengadaptasian terhadap perubahan kebutuhan serta perkembangan dunia pendidikan yang terus berlangsung.</p>
            
              <div class="row gy-2 gx-4 mb-4" >
                
                      <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Program Kerja</p>
                      <ul>
                          <li>Workshop dengan berkolaborasi dengan kaprodi setiap jurusan</li>
                          <li>Workshop Pengembangan diri (Critical Thingking, dll)</li>
                          <li>Optimasi dan Latihan Dasar Kepemimpinan Mahasiswa</li>
                          <li>Perlombaan Akademik</li>
                          <li>Membuat Blog atau Artikel Bulanan</li>
                        </ul>
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
  <div class="container">
      <div class="text-center">
          <h6 class="section-title bg-white text-center text-primary px-3">Departemen Pendidikan</h6>
