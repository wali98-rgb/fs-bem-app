            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Departemen Ekonomi</h1>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
              <div class="position-relative h-100">
                  <img class="img-fluid position-absolute w-100 h-100" 
                       src="{{ asset('plugins/frontend/img/ekonomi.png') }}" 
                       alt="" 
                       style="object-fit: contain; ">
              </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              <h6 class="section-title bg-white text-start text-primary pe-3">Departemen Ekonomi</h6>
              <h1 class="mb-4">Tugas Pokok dan Fungsi</h1>
              <p class="mb-4 " style="text-align: justify;">Bertanggung jawab untuk mengelola perekonomian BEM dengan mencari dana, manfaat, dan sponsorship secara kreatif dan inovatif. Tugas ini meliputi perencanaan, pelaksanaan strategi pendanaan, serta menjalin kemitraan untuk mendukung kegiatan kabinet BEM, dengan fokus pada keberlanjutan dan kesuksesan finansial organisasi
                <div class="row gy-2 gx-4 mb-4" >
                
                      <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Program Kerja</p>
                      <ul>
                          <li>Warung BEM (Makanan, Minuman dan Barang)</li>
                          <li>Pengadaan Barang dan Jasa (Merchandise, Jasa Design atau Reseller)</li>
                          <li>Bazzar</li>
                        </ul>
