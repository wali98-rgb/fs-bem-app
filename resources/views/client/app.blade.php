                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            ...
                            <p class="fs-5 text-white mb-4 pb-2">Organisasi Badan Eksekutif Mahasiswa yang berfokus pada perubahan transformasi atau perbaikan menuju arah yang lebih baik. Bertujuan untuk menghadirkan perubahan positif melalui kolaborasi dan kebersamaan.</p>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('plugins/frontend/img/yos.jpg')}}" alt="" style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/4.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/5.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/2.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/1.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/3.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/7.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/6.jpg')}} style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src={{ asset('plugins/frontend/img/8.jpg')}} style="width: 80px; height: 80px;">
